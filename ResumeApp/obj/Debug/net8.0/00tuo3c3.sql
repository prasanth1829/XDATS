...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260112051008_AddUserSessionLog'
)
BEGIN
    CREATE TABLE [UserSessionLogs] (
        ...
        [IsAutoLogout] bit NOT NULL,
        CONSTRAINT [PK_UserSessionLogs] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_UserSessionLogs_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE INDEX [IX_UserSessionLogs_LogoutTime] ON [UserSessionLogs] ([LogoutTime]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_UserSessionLogs_UserId_LoginTime] ON [UserSessionLogs] ([UserId], [LoginTime]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260112051008_AddUserSessionLog', N'8.0.17');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260112103350_AddLastSeenAtToUserSessionLogs'
)
BEGIN
    ALTER TABLE [UserSessionLogs] ADD [LastSeenAt] datetime2 NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260112103350_AddLastSeenAtToUserSessionLogs', N'8.0.17');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260114061016_AddCandidateCallLog'
)
BEGIN
    CREATE TABLE [CandidateCallLogs] (
        [Id] int NOT NULL IDENTITY,
        [ResumeId] int NOT NULL,
        [RequirementId] int NOT NULL,
        [PhoneNumber] nvarchar(max) NOT NULL,
        [CallStartTime] datetime2 NOT NULL,
        [CallEndTime] datetime2 NULL,
        [Outcome] nvarchar(max) NULL,
        [Notes] nvarchar(max) NULL,
        [CalledByUserId] nvarchar(max) NOT NULL,
        [CreatedAt] datetime2 NOT NULL,
        CONSTRAINT [PK_CandidateCallLogs] PRIMARY KEY ([Id])
    );
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260114061016_AddCandidateCallLog', N'8.0.17');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260114064114_AddCandidateDetails'
)
BEGIN
    CREATE TABLE [CandidateDetails] (
        ...
        [RelevantExperience] decimal(18,2) NULL,
        ...
        CONSTRAINT [PK_CandidateDetails] PRIMARY KEY ([Id])
    );
END;
GO
...
BEGIN
    CREATE UNIQUE INDEX [IX_CandidateDetails_ResumeId_RequirementId] ON [CandidateDetails] ([ResumeId], [RequirementId]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260114064114_AddCandidateDetails', N'8.0.17');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260217062759_IncreaseResumeSkillLength'
)
BEGIN
    CREATE TABLE [ResumeSkills] (
        ...
        CONSTRAINT [PK_ResumeSkills] PRIMARY KEY ([Id]),
...
BEGIN
    CREATE INDEX [IX_ResumeSkills_SkillName] ON [ResumeSkills] ([SkillName]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260217062759_IncreaseResumeSkillLength', N'8.0.17');
END;
GO
